...
Module _7zForRevolt
    ...
    Function TrackInfoFile(ByVal archivePath As String) As TrackInfo
        ...
        Dim x As New SevenZipExtractor(archivePath)
        ...
        Dim xa As New SevenZipExtractor(archivePath)
        Try
    ...
    Sub ExtractAll()
        ...
        'ChDir(RvDir)
        'IO.File.Copy(Environ("temp") & "\temp_01.bmp", CurDir() & "\gfx\" & Te.foldername & ".bmp")
