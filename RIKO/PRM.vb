...
Public Class PRM
    ...
    Public Class BBOX
        ...
        End Sub
        Dim Clr = New OpenTK.Graphics.Color4(0.5!, 0.5!, 0.5!, 1)
        Dim ClrT = 0, CC
        Sub Render(ByVal Matrix As Matrix4, ByVal zoom!)
    ...
    Sub New(ByVal filepath As String, Optional ByVal DoNotAdd As Boolean = False, Optional ByVal DoNeverRemove As Boolean = False)
        ...
        If IO.File.Exists(filepath) = False Then
            If IO.File.Exists(RVPATH & filepath) Then
                filepath = RVPATH & filepath
            Else
        ...
        DoWrite("Polys in " & Split(filepath, "\").Last & ":" & MyModel.polynum)
    ...
    Sub Export()
        ...
        Dim filepath$ = Directory & "\" & FileName
        IO.File.Copy(filepath, filepath & "_bck" & TimeOfDay.Ticks, True)
    ...
    Sub Render()
        ...
        For i = 0 To Me.MyModel.polynum - 1
            ...
            GL.Begin(RenderType)
            GL.Color4(MyModel.polyl(i).c(0).ReturnBaked(GlobalAlpha))
            ...
            GL.Color4(MyModel.polyl(i).c(2).ReturnBaked(GlobalAlpha))
            ...
            GL.Color4(MyModel.polyl(i).c(1).ReturnBaked(GlobalAlpha))
...
SkipDBLSD:
            ...
            If (MyModel.polyl(i).type And PolyType.QUAD) Then
                ...
                GL.Color4(MyModel.polyl(i).c(3).ReturnBaked(GlobalAlpha))
...
Public Structure POLY
    ...
    Public Class BakedColor
        ...
        Property Gray()
            ...
            End Get
        End Property
        Sub New(ByVal CC As Color)
            AlphaEnabled = False
            LongColor = ColorToUint(CC)
        End Sub
